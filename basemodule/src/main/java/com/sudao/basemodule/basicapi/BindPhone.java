...
public class BindPhone {
    ...
    public void doBind(String phone, String password, String code, String inviteCode) {
        if (checkInputValidity(phone, password, code) == 1) {
            ...
            Call<BaseResponse<Object>> call = baseService.bindPhone(registRequest);
    ...
    public void doBindWithRegistRequest(RegistRequest registRequest) {
        BaseService baseService = HTTPHelper.getBaseService();
        Call<BaseResponse<Object>> call = baseService.bindPhone(registRequest);
        call.enqueue(new CommonCallback<BaseResponse<Object>>() {
            @Override
