...
public class ChatExtendMenu extends GridView {
    ...
    private void init(Context context, AttributeSet attrs) {
        LogUtil.d("ChatExtendMenu", "init初始化");
        ...
        setVerticalSpacing(ScreenHelper.dp2px(context, 8));
    }
    ...
    public void registerMenuItem(String name, int drawableRes, int itemId, ChatExtendMenuItemClickListener listener) {
        ...
        item.id = itemId;
        item.mExtendMenuItemClickListener = listener;
        itemModels.add(item);
    }
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            menuItem.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (getItem(position).mExtendMenuItemClickListener != null) {
                        getItem(position).mExtendMenuItemClickListener.onClick(getItem(position).id, v);
                    }
                }
            });
            return convertView;
    ...
    class ChatMenuItemModel {
        ...
        int image;
        int id;
        ChatExtendMenuItemClickListener mExtendMenuItemClickListener;
    }
