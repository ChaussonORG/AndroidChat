package com.sudaotech.chatlibrary.view;
...
/**
 * Created by Samuel on 2017/2/4 16:20.
...
public class BubbleImageView extends ImageView {
    ...
    private int mArrowTop = dp2px(20);
    private int mArrowWidth = dp2px(20);
    private int mArrowHeight = dp2px(10);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        RectF rectF = new RectF(getPaddingLeft(), getPaddingTop(), getRight()
