...
import com.sudaotech.chatlibrary.widget.BaseEmojiconMenu;
 ...
 * Emojicon menu
 */
public class EmojiconMenu extends BaseEmojiconMenu {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ChatEmojiconMenu);
        int defaultColumns = 7;
        emojiconColumns = ta.getInt(R.styleable.ChatEmojiconMenu_emojiconColumns, defaultColumns);
        int defaultBigColumns = 4;
        bigEmojiconColumns = ta.getInt(R.styleable.ChatEmojiconMenu_bigEmojiconRows, defaultBigColumns);
        ta.recycle();
    ...
    private class EmojiconPagerViewListener implements EmojiconPagerView.ChatEmojiconPagerViewListener {
        ...
        public void onDeleteImageClicked() {
            if (mEmojiconMenuListener != null) {
                mEmojiconMenuListener.onDeleteImageClicked();
            }
        }
        ...
        public void onExpressionClicked(Emojicon emojicon) {
            if (mEmojiconMenuListener != null) {
                mEmojiconMenuListener.onExpressionClicked(emojicon);
            }
        }
